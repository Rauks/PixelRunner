...
public class SuccessDatabase extends Database{
    ...
    public enum Success{
        ...
        ISLANDS("islands", R.string.success_islands, R.string.success_islands_sub),
        FORTRESS("fortress", R.string.success_fortress, R.string.success_fortress_sub),
        SPACE("space", R.string.success_space, R.string.success_space_sub),
