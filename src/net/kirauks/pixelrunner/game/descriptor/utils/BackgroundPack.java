...
public enum BackgroundPack{
    ...
    ISLANDS(Layer.CLOUDS_2.withSpeed(20), Layer.ISLANDS_3.withSpeed(25), Layer.ISLANDS_2.withSpeed(30), Layer.ISLANDS_1.withSpeed(35)),
